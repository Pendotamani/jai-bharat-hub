  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "About Jai Bharat Junior College — 19 years of educational excellence with 26+ experienced faculty.",
      },
      {
        property: "og:title",
        content: "About Jai Bharat Junior College",
      },
      {
        property: "og:description",
        content: "19 years of excellence. 26+ experienced faculty members.",
      },
    ],
  }),
  component: AboutPage,
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="text-center">
          <img
            src={logo}
            alt={COLLEGE_NAME}
            className="mx-auto h-24 w-24 rounded-full object-cover shadow-lg ring-4 ring-primary/20"
          />
